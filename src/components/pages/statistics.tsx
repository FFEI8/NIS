...
export default function StatisticsPage() {
  const { loaded, loadAllConfigs } = useConfigStore();
  ...
  // Department infection rates from API
  const displayDepts = deptRates.slice(0, 5);
  const displayAntibiotic = monthlyAntibiotic;
